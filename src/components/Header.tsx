...
const Header: FC = () => {
  ...
  return (
    <header className="fixed pt-6 top-0 left-0 w-full p-4 backdrop-blur-md text-white z-10">
      ...
      <div className={`lg:hidden ${isMenuOpen ? "block" : "hidden"}`}>
        <ul className="flex flex-col items-end gap-4 p-4 text-right min-h-screen">
          <li className="my-4">
          ...
          <li className="my-4">
            <a href="#contact" className="hover:text-yellow-300" onClick={closeMenu}>
              Contact
            </a>
          </li>
        </ul>
